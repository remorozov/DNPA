...
window.onload = function() {
    history.pushState("fds", document.title, window.location.pathname);
...
new fullpage("#fullpage", {
    ...
    onLeave: (origin, destination, direction) => {
        ...
        const header_text_description1 = section.getElementsByClassName('header_text_description1')
        const header_text_description2 = section.getElementsByClassName('header_text_description2')
        const contacts_menu = document.getElementsByClassName('contacts_menu')[0]
        const parallax = document.getElementById("parallax");
        const coords = parallax.getBoundingClientRect();
        const header_ul_li = section.getElementsByClassName('header_ul_li')
        const product_responsive = section.getElementsByClassName('product_responsive')
        const client_row = section.getElementsByClassName('client_row')
            // timelines
        ...
        // timer for FAQ
        tl3.fromTo(title, 0.5, { y: 200, opacity: 0, scale: 0.8 }, { y: 0, opacity: 1, scale: 1 })
        ...
        if (destination.index == "0" && direction == "down") {
            ...
            tl12.fromTo(
                parallax,
                1.2, { y: "0" }, { y: -(destination.index + 1) * 40, }
            );
        }
        if (destination.index == "1" && direction == "down") {
            tl12.fromTo(
                parallax,
                1.2, { y: coords.top }, { y: -(destination.index + 1) * 40, }
            );
        }
        ...
        if (destination.index === 0) {
            ...
            tl3.fromTo(header_text_description1, 0.5, { x: 150, opacity: 0 }, { x: 0, opacity: 1 })
            tl3.fromTo(header_text_description2, 0.5, { x: 150, opacity: 0 }, { x: 0, opacity: 1 })
        ...
        if (destination.index === 1) {
            ...
            tl4.fromTo(
                slider,
                0.7, { scale: 1.4, opacity: 0, x: 500, y: 200 }, { scale: 1, opacity: 1, x: 0, y: 0 }
            );
            tl.fromTo(contacts_menu, 0.5, { height: contacts_menu.style.height, width: contacts_menu.style.width }, { height: 250, width: 90 })
        ...
        if (destination.index === 2) {
            ...
            tl4.fromTo(
                slider1,
                1, { scale: 1.4, opacity: -0.5, x: -500, y: 500 }, { scale: 1, opacity: 1, x: 0, y: 0 }
            );
            tl3.fromTo(product_responsive, 1, { x: -3000 }, { x: 0 })
            tl.fromTo(contacts_menu, 0.5, { height: contacts_menu.style.height, width: contacts_menu.style.width }, { height: 250, width: 90 })
        ...
        if (destination.index === 3) {
            ...
            tl2.fromTo(
                services_item[0],
                0.5, { x: "-1300", opacity: 0 }, { x: "0", opacity: 1 }
            );
            tl2.fromTo(
                services_item[1],
                0.5, { x: "1300", opacity: 0 }, { x: "0", opacity: 1 }
        ...
        if (destination.index === 5) {
            ...
            tl3.fromTo(client_row, 1, { opacity: 0, scale: 0.8 }, { opacity: 1, scale: 1 })
            tl.fromTo(contacts_menu, 0.5, { height: contacts_menu.style.height, width: contacts_menu.style.width }, { height: 250, width: 90 })
